...
- **Backend**: 
  ...
  - 🛢️ **Mongoose**: ODM for MongoDB, simplifying database interactions.
...
- 🖥️ Node.js and npm (Node Package Manager) installed on your machine.
- 🗄️ MongoDB server running locally or a MongoDB Atlas account for cloud storage.
